        ...
        return{
            ...
            controller:"Ctrl",
                link:function($scope,iElement,iAttributes, ctrl){
                    ...
                    if($scope.percentage){
                        ...
                        for(var i=0;i<$scope.totalSlice;i++){
                            ...
                            console.log(-90+$scope.default_angles[i]);
                        }
                    }else{
                        for(var i=0;i<$scope.totalSlice;i++){
                ...
                template:"<svg height=\"{{radius*2+border_thickness}}\" width=\"{{radius*2+border_thickness}}\">"+
                        ...
                        "</svg>"+
                        /*"<div class=\"pie_slice\" ng-repeat=\"arr in colorsData track by $index\" ng-touchstart=\"startMoveSlice($event)\" ng-mousedown=\"startMoveSlice($event)\" style='left:121px; top:113px; width:120px;'><div style='height:2px; background-color:white; top:6.5px; position:relative;'></div></div>"*/
                        "<div class=\"pie_slice\" ng-repeat=\"arr in colorsData track by $index\" style='left:121px; top:113px; width:120px;'><div style='height:2px; background-color:white; top:6.5px; position:relative;'></div></div>"
            }
            ...
            $scope.setTransform = function(id,angle){
                ...
                //console.log(angle);
                $($scope.directiveElement).find(".pie_slice").eq(id).css("transform","rotate("+angle+"deg)");
            ...
            $scope.startMoveSlice = function(evt){
                ...
                $("body").on("mouseup touchend", stopMove_javascript);
                $("body").on("mouseleave", stopMove_javascript);
            ...
            function stopMove_javascript(){
                $("body").off("mouseup touchend", stopMove_javascript);
                $("body").off("mouseleave", stopMove_javascript);
